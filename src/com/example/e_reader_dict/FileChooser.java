...
/**
 * Created by Kraft on 27.10.2016.
 */
...
public class FileChooser {
    ...
    private void refresh(File path) {
        ...
        if (path.exists()) {
            ...
            if (path.getParentFile() == null) {
                ...
                fileList[i++] = activity.getString(R.string.cancel_add_book);
            } else {
    ...
    private File getChosenFile(String fileChosen) {
        if (fileChosen.endsWith(activity.getString(R.string.cancel_add_book))) {
            return null;
        }
